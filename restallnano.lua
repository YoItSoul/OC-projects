...
local intervalblock = 0
for i = 1,inps do
  Letscheckitall()
  intervalblock = intervalblock + 1
end

  function Letscheckitall()
  send("getTotalInputCount")
  ...
  print("...and activating your block number...",intervalblock)
  activate(intervalblock)
  for i = intervalblock,inps do
    local x1, x2
    activate(i)
    send("getActiveEffects")
    x1 = receive("effects")
  ...
  deactivate(intervalblock)
  print("Deactivating the block number...",intervalblock)
  print("Summary:")
  printEffects()
